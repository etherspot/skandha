...
export declare namespace IEntryPointSimulations {
  ...
  export type ValidationResultStruct = {
    ...
    aggregatorInfo: IEntryPointSimulations.AggregatorStakeInfoStruct;
  };
  ...
  export type ValidationResultStructOutput = [
    ...
    IStakeManager.StakeInfoStructOutput,
    IStakeManager.StakeInfoStructOutput,
    IEntryPointSimulations.AggregatorStakeInfoStructOutput
  ] & {
    ...
    aggregatorInfo: IEntryPointSimulations.AggregatorStakeInfoStructOutput;
  };
}
...
export interface EntryPointSimulationsInterface extends utils.Interface {
  functions: {
    ...
    "validateSenderAndPaymaster(bytes,address,bytes)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "validateSenderAndPaymaster",
    values: [
      PromiseOrValue<BytesLike>,
      PromiseOrValue<string>,
      PromiseOrValue<BytesLike>
