...
export declare namespace IEntryPoint {
  ...
  export type UserOpsPerAggregatorStructOutput = [
    UserOperation06StructOutput[],
    string,
    string
  ] & {
    userOps: UserOperation06StructOutput[];
    aggregator: string;
    signature: string;
  };
}
...
export interface IEntryPointInterface extends utils.Interface {
  ...
  encodeFunctionData(
    ...
    values: [UserOperation06Struct[], PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
...
export interface IEntryPoint extends BaseContract {
  ...
  functions: {
    ...
    getDepositInfo(
      ...
      [IStakeManager06.DepositInfoStructOutput] & {
        info: IStakeManager06.DepositInfoStructOutput;
      }
    >;
  ...
  getDepositInfo(
    account: PromiseOrValue<string>,
    overrides?: CallOverrides
  ): Promise<IStakeManager06.DepositInfoStructOutput>;
