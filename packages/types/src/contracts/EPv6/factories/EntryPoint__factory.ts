    ...
    inputs: [
      {
        ...
        internalType: "struct IIEntryPoint.ReturnInfo",
        name: "returnInfo",
        type: "tuple",
      },
      {
  ...
  },
  {
    inputs: [
      ...
      },
      {
        ...
        internalType: "struct IIEntryPoint.AggregatorStakeInfo",
        name: "aggregatorInfo",
        type: "tuple",
      },
    ],
    ...
    inputs: [
      {
        ...
        internalType: "struct IIEntryPoint.UserOpsPerAggregator[]",
  ...
  },
  {
    inputs: [
      ...
      },
      {
        components: [
          {
            ...
            internalType: "struct IEntryPoint.MemoryUserOp",
            name: "mUserOp",
            type: "tuple",
          },
          {
        ...
        internalType: "struct IEntryPoint.UserOpInfo",
        name: "opInfo",
        type: "tuple",
      },
      {
...
type IEntryPointConstructorParams =
  | [signer?: Signer]
  | ConstructorParameters<typeof ContractFactory>;

const isSuperArgs = (
  xs: IEntryPointConstructorParams
): xs is ConstructorParameters<typeof ContractFactory> => xs.length > 1;

export class IEntryPoint__factory extends ContractFactory {
  constructor(...args: IEntryPointConstructorParams) {
    if (isSuperArgs(args)) {
      super(...args);
    } else {
  ...
  override deploy(
    ...
    return super.deploy(overrides || {}) as Promise<IEntryPoint>;
  }
  ...
  override attach(address: string): IEntryPoint {
    return super.attach(address) as IEntryPoint;
  }
  override connect(signer: Signer): IEntryPoint__factory {
    return super.connect(signer) as IEntryPoint__factory;
  }
