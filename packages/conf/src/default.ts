import {gnosisNetworkConfig, IBundlerNetworkConfig, maticNetworkConfig} from "./networks";
import { mainnetNetworkConfig, mumbaiNetworkConfig, goerliNetworkConfig } from "./networks";
