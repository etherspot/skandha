...
export enum GossipType {
  ...
  export type GossipTopicTypeMap = {
    [GossipType.user_operations_with_entrypoint]: {type: GossipType.user_operations_with_entrypoint};
  };
  ...
  export type GossipFnByType = {
    [GossipType.user_operations_with_entrypoint]: (signedUserOps: any) => Promise<void> | void;
  };
