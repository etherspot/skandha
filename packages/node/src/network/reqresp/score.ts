import { RequestError, RequestErrorCode } from "../../reqresp/request/index.js";
...
export function onOutgoingReqRespError(
  e: RequestError,
  ...
  switch (e.type.code) {
    ...
    case RequestErrorCode.DIAL_ERROR:
      return e.message.includes(
        multiStreamSelectErrorCodes.protocolSelectionFailed
