...
import { ErrorAborted, withTimeout, TimeoutError } from "@byzanlink-bundler/utils/lib";
        ...
        abortableSource(stream.source as AsyncIterable<Uint8ArrayList>, [
          {
            ...
            getError: () =>
              new RequestInternalError({ code: RequestErrorCode.TTFB_TIMEOUT }),
          },
          {
            signal: respTimeoutController.signal,
            getError: () =>
              new RequestInternalError({ code: RequestErrorCode.RESP_TIMEOUT }),
          },
        ]),
